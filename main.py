...
from process_data.procs_por_assunto import list_assuntos, list_procs_by_assunto
...
@app.get('/processos_por_assunto/')
@encapsulate_response
def lista_de_procs_por_assunto(assunto : str, json_alike: Optional[bool] = None):

    if json_alike is None:
        json_alike = True

    return list_procs_by_assunto(assunto, json_alike=json_alike)